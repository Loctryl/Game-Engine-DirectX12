...
bool FrustumCulling::isOnFrustum(Frustum& camFrustum, Transform& transform)
{
	//Get global scale thanks to our transform
	XMVECTOR globalCenter = XMVector3Transform(XMLoadFloat4(&XMFLOAT4(Center.x, Center.y, Center.z, 1.0f)), XMLoadFloat4x4(&transform.GetWorldMatrix()));
